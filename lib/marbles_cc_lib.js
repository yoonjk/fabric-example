...
module.exports = function (enrollObj, g_options, fca, logger) {
	...
	marbles_chaincode.check_if_already_instantiated = function (options, cb) {
		...
		fca.query_chaincode(enrollObj, opts, function (err, resp) {  // send a request to our peer
			if (err != null) {
	...
	marbles_chaincode.check_version = function (options, cb) {
		...
		fca.query_chaincode(enrollObj, opts, function (err, resp) {
			if (err != null) {
				if (cb) return cb(err, resp);
			}
			else {
	...
	marbles_chaincode.create_a_marble = function (options, cb) {
		...
		fca.invoke_chaincode(enrollObj, opts, function (err, resp) {
			if (cb) {
				if (!resp) resp = {};
	...
	marbles_chaincode.get_marble = function (options, cb) {
		...
		fca.query_chaincode(enrollObj, opts, cb);
	};
	...
	marbles_chaincode.set_marble_owner = function (options, cb) {
		...
		fca.invoke_chaincode(enrollObj, opts, cb);
	};
